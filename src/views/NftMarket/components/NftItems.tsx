...
const NftItems = () => {
    ...
    const fetchNftItems = useCallback(async() => {
        ...
        console.log("Filtered Market Items:", filteredTmpMarketItems);
        let index = 0;
        switch (collectionType.field) {
            ...
            case "HappyCows":
                for(let i = 0; i < filteredTmpMarketItems.length; i ++) {
                    if(filteredTmpMarketItems[i].nftContract === "0x619e89a0b5f1B8a58731b26739C31761EDb577ab") {
